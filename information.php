...
.fa-circle-xmark:hover, .fa-circle-xmark:focus{
	color: #000;
...
.closeBttn:hover, .closeBttn:focus{
	color: #000;
	text-decoration: none;
	cursor: pointer;
}
	...
	<div class="reservation-box">
		...
		<div class="border2">
			<form class="" action="" method="post">
				<p class="current-date">CURRENT DATE:</p><p id="crrnt_date" class="crrnt-date"></p>
				<p class="text4">Check-in</p><p class="text5">Check-out</p>
