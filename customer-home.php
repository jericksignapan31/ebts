...
<body style="overflow-x:hidden;">
  ...
  <div class="container">
    ...
    while ($row = $stat->fetch()) {?>
      ...
      <head><h3 style='font-size:1.17em;overflow:auto;font-family:Moonglade;'><br><img src='image/location-removebg-preview.png' style='width:6%;'>" <?php echo $row['location'] ?> "</h3>";
