...
<div class="home">
    <h1 style='color:#38231d;'>··· ADMIN TRAIL ···</h1>
...
<body onload="realtimeClock()">
    ...
    <section style="position:absolute; margin-left:20%; margin-top:6%;">
        <div class="topnav">
            <div class="search-container">
                <form action="" method=POST>
                    <p style="visibility:hidden">ID Search</p>
                    <input type="text" placeholder="Search Here..." name="search">
                    <button type="submit" name="seee" style='background-color:#38231d;color:white;width:7%;font-family: Orelega One cursive;'>Search</button>
                    <a href="admin-trail.php"><button style='background-color:#38231d;color:white;width:7%;font-family: Orelega One cursive;'>View All</button></a>
                </form>
        ...
        if (isset($_POST['seee'])) {
            ...
            if ($result1 == TRUE) {
                ...
                echo "<body>";
                echo "<center>";
                echo "<div style='height:700px; overflow:scroll;overflow-x:hidden; width:1250px'><table id=customers border-collapse: collapse;
cellspacing=0 cellpadding=0; >";
                ...
                if ($result2 == TRUE) {
                    ...
                    echo "<body>";
                    echo "<center>";
                    echo "<div style='height:500px; overflow:scroll; overflow-x:hidden; width:1250px'><table id=customers border-collapse: collapse;
    cellspacing=0 cellpadding=0; >";
                    echo "<tr>";
                    echo "<th>ID";
                    echo "<th>NAME";
            ...
            if ($result1 == TRUE) {
                ...
                echo "<body>";
                echo "<center>";
                echo "<div style='height:700px; width:1250px; overflow:scroll; overflow-x:hidden'><table id=customers border-collapse: collapse;
cellspacing=0 cellpadding=0; >";
                echo "<tr>";
                echo "<th>ID";
                echo "<th>NAME";
